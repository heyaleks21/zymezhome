...
const Landing = () => {
  return (
    <>
      <div className="min-w-screen flex min-h-screen scale-75 items-center justify-center overflow-hidden sm:scale-100">
        <div className="slidedown flex w-96 flex-col items-center justify-start gap-4">
